...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.ActivationCode = field.NewString(tableName, "activation_code")
	_user.Role = field.NewString(tableName, "role")
	_user.IsSubscribed = field.NewBool(tableName, "is_subscribed")
	_user.SubscriptionType = field.NewString(tableName, "subscription_type")
	_user.SubscriptionEnd = field.NewTime(tableName, "subscription_end")
	_user.MaxApps = field.NewInt(tableName, "max_apps")
	_user.MaxTranslations = field.NewInt(tableName, "max_translations")
	_user.CurrentUsage = field.NewInt(tableName, "current_usage")
	_user.CurrentAppCount = field.NewInt(tableName, "current_app_count")
...
type user struct {
	...
	ActivationCode   field.String
	Role             field.String
	IsSubscribed     field.Bool
	SubscriptionType field.String
	SubscriptionEnd  field.Time
	MaxApps          field.Int
	MaxTranslations  field.Int
	CurrentUsage     field.Int
	CurrentAppCount  field.Int
...
func (u *user) updateTableName(table string) *user {
	...
	u.ActivationCode = field.NewString(table, "activation_code")
	u.Role = field.NewString(table, "role")
	u.IsSubscribed = field.NewBool(table, "is_subscribed")
	u.SubscriptionType = field.NewString(table, "subscription_type")
	u.SubscriptionEnd = field.NewTime(table, "subscription_end")
	u.MaxApps = field.NewInt(table, "max_apps")
	u.MaxTranslations = field.NewInt(table, "max_translations")
	u.CurrentUsage = field.NewInt(table, "current_usage")
	u.CurrentAppCount = field.NewInt(table, "current_app_count")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["activation_code"] = u.ActivationCode
	u.fieldMap["role"] = u.Role
	u.fieldMap["is_subscribed"] = u.IsSubscribed
	u.fieldMap["subscription_type"] = u.SubscriptionType
	u.fieldMap["subscription_end"] = u.SubscriptionEnd
	u.fieldMap["max_apps"] = u.MaxApps
	u.fieldMap["max_translations"] = u.MaxTranslations
	u.fieldMap["current_usage"] = u.CurrentUsage
	u.fieldMap["current_app_count"] = u.CurrentAppCount
}
