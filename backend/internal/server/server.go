...
func NewAppWithDB(db *database.Database) (*fiber.App, error) {
	...
	protected.Get("/appleconnections", handleGetAppleConnectConfigs)
	protected.Post("/appleconnections", handleCreateAppleConnectConfig)
	protected.Get("/appleconnections/:id", handleGetAppleConnectConfig)
	protected.Put("/appleconnections/:id", handleUpdateAppleConnectConfig)
	protected.Delete("/appleconnections/:id", handleDeleteAppleConnectConfig)
	protected.Post("/appleconnections/:id/test", handleTestAppleConnectConnection)
	protected.Post("/appleconnections/test", handleTestAppleConnectCredentials)
...
func handleUpdateProviderConfig(c *fiber.Ctx) error {
	...
	if req.ConfigData != nil {
		...
		providerType := config.ProviderType  // Use existing config's type by default
		if req.ProviderType != nil {
...
// Apple Connect configuration handlers

func handleGetAppleConnectConfigs(c *fiber.Ctx) error {
	userID, ok := GetUserIDFromContext(c)
	if !ok {
		return fiber.NewError(fiber.StatusUnauthorized, "User not authenticated")
	}
...
func handleCreateAppleConnectConfig(c *fiber.Ctx) error {
	userID, ok := GetUserIDFromContext(c)
	if !ok {
		return fiber.NewError(fiber.StatusUnauthorized, "User not authenticated")
	}
...
func handleGetAppleConnectConfig(c *fiber.Ctx) error {
	configID, err := c.ParamsInt("id")
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, "Invalid config ID")
	}
...
func handleUpdateAppleConnectConfig(c *fiber.Ctx) error {
	configID, err := c.ParamsInt("id")
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, "Invalid config ID")
	}
...
func handleDeleteAppleConnectConfig(c *fiber.Ctx) error {
	configID, err := c.ParamsInt("id")
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, "Invalid config ID")
	}
...
func handleTestAppleConnectConnection(c *fiber.Ctx) error {
	configID, err := c.ParamsInt("id")
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, "Invalid config ID")
	}
...
func handleTestAppleConnectCredentials(c *fiber.Ctx) error {
	userID, ok := GetUserIDFromContext(c)
	if !ok {
		return fiber.NewError(fiber.StatusUnauthorized, "User not authenticated")
	}
